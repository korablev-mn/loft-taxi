...
<svg xmlns="http://www.w3.org/2000/svg" height="26" width="24" id="svg895" version="1.1" viewBox="-96 -98.908 832 593.448">
    <defs id="defs879">
        <style id="style877" type="text/css"> <div className="e">fill:#f79e1b</div> </style>
    </defs>
